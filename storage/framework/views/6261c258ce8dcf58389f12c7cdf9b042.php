...
<section class="cabecario">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><?php echo e($resume->informacoesPessoais->nome); ?> </li>
        </ol>
      </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h3><?php echo e($resume->vagas_interesse[0]); ?></h3>
                </div>
                <div class="col">
                    ...
                    <div class="container-acoes d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('resumes.edit', $resume)); ?>" class="btn-editar">
            ...
            <div class="row mt-5 mb-3 container-info">                
                <div class="col text-center">
                    <h4><?php echo e(\Carbon\Carbon::parse($resume->informacoesPessoais->data_nascimento)->age); ?></h4>
                    <p>Anos</p>
                </div>
                <div class="col text-center">
                    <h4>2</h4>
    ...
    <article class="f2-1">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-4">
                    <p>Inglês</p>
                    <h4><?php echo e($resume->escolaridade->ingles); ?></h4>
                </div>
                <div class="col-2">
                    <p>Informática</p>
                    <h4><?php echo e($resume->escolaridade->informatica); ?></h4>
                </div>
                <div class="col-2">
                    <p>Reservista</p>
                    <h4><?php echo e($resume->informacoesPessoais->reservista); ?></h4>
                </div>
                <div class="col-2">
                    <p>Nascimento</p>
                    <h4><?php echo e($resume->informacoesPessoais->data_nascimento->format('d/m/y')); ?></h4>
                </div>
                <div class="col-2">
                    <p>Escolaridade</p>
                    <h4><?php echo e($resume->escolaridade->escolaridade); ?></h4>
                </div>
            </div>
            <div class="row mb-5">
                <div class="col-2">
                    <p>Cidade</p>
                    <h4><?php echo e($resume->contato->cidade); ?></h4>
                </div>
                <div class="col-2">
                    <p>Bairro</p>
                    <h4><?php echo e($resume->contato->bairro); ?></h4>
                </div>
                <div class="col-2">
                    <p>Sexo</p>
                    <h4><?php echo e($resume->informacoesPessoais->sexo); ?></h4>
                </div>
                <div class="col-2">
                    <p>Disponibilidade</p>
                    <h4>
                        <?php if($resume->interview): ?>
                            <?php echo e($resume->interview->disponibilidade_horario); ?>
                ...
                <div class="col-2">
                    ...
                    <h4>
                        <?php if($resume->interview): ?>
                            <?php echo e($resume->interview->fonte_curriculo); ?>
                ...
                <div class="col-2">
                    ...
                    <h4>
                        <?php if($resume->interview): ?>
                            <?php echo e($resume->interview->saude_candidato); ?>
            ...
            <div class="row mb-3">
                <div class="col-4">
                    <p>Telefone</p>
                    <h4><?php echo e($resume->contato->telefone_residencial); ?></h4>                    
                </div>
                <div class="col-4">
                    <p>E-mail</p>
                    <h4><?php echo e($resume->contato->email); ?></h4>                    
                </div>                
                <div class="col-8">
                    <p>Por que gostaria de ser um Jovem Aprendiz?</p>
                    <h4>
                        <?php if( $resume->interview): ?>
                            <?php echo e($resume->interview->porque_ser_jovem_aprendiz); ?>
            ...
            <div class="row">
                <div class="col-6 d-flex justify-content-start mt-3">
                    ...
                    <a href="<?php echo e(route('jobs.index')); ?>" class="btn-padrao btn-cadastrar ms-3">Mais informações</a>
                </div>
                <div class="col-6">
                    <p>Observações:</p>
                    <h4>
                        <?php if( $resume->interview): ?>
                            <?php echo e($resume->interview->observacoes); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/flav6095/painelasppe.com.br/resources/views/resumes/show.blade.php ENDPATH**/ ?>