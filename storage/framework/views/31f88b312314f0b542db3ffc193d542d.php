<!-- Bootstrap Modal -->
<div class="modal fade" id="jobResumesModal-<?php echo e($job->id); ?>" tabindex="-1" aria-labelledby="jobResumesModalLabel-<?php echo e($job->id); ?>" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-5">
                            <h5 class="modal-title" id="jobResumesModalLabel-<?php echo e($job->id); ?>">Candidatos Selecionados - <?php echo e($job->cargo); ?></h5>                
                        </div>
                        <div class="col-5">
                            <div class="buscar">
                    ...
                    <?php if($resumes->count() > 0): ?>
                        <?php $__currentLoopData = $resumes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resume): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row p-2 tabela-modal-linha">
                                ...
                                <div class="col-3"><?php echo e($resume->informacoesPessoais->nome); ?></div>
                                <div class="col-4"><?php echo e($resume->contato->email); ?></div>
                                <div class="col-4"><?php echo e($resume->contato->telefone_residencial); ?></div>
                                <div class="col-1">
                                    <a href="<?php echo e(route('resumes.edit', $resume->id)); ?>" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Visualizar currículo">
...
<?php /**PATH /home1/flav6095/painelasppe.com.br/resources/views/components/job-resume-modal.blade.php ENDPATH**/ ?>