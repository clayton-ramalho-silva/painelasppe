        ...
        <div class="container">
            ...
            <form class="form-padrao" id="form-interview" action="<?php echo e(route('interviews.update', $interview)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Saúde do Candidato" id="saude_candidato" name="saude_candidato" required value="<?php echo e($interview->saude_candidato); ?>">
                        ...
                        <div class="mb-3">
                            <div class="floatlabel-wrapper required">
                                ...
                                <select name="vacina_covid" id="vacina_covid" class="form-select active-floatlabel" required>
                                    ...
                                    <option value="4 doses" <?php echo e($interview->vacina_covid === '4 doses' ? 'selected' : ''); ?>> 4 doses</option>
                                    <option value="5 ou mais doses" <?php echo e($interview->vacina_covid === '5 ou mais doses' ? 'selected' : ''); ?>> 5 ou mais doses</option>
                                </select>
                        ...
                        <div class="mb-3">
                            <div class="floatlabel-wrapper required">
                                ...
                                <select name="perfil" id="perfil" class="form-select active-floatlabel" required>
                                    ...
                                    <option value="Administrativo" <?php echo e(strtolower($interview->perfil) === 'administrativo' ? 'selected' : ''); ?>> Administrativo</option>
                                    <option value="Operacional" <?php echo e(strtolower($interview->perfil) === 'operacional' ? 'selected' : ''); ?>> Operacional</option>
                                    <option value="Adm / Operacional" <?php echo e(strtolower($interview->perfil) === 'adm / operacional' ? 'selected' : ''); ?>> Adm / Operacional</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" id="qual_formadora" name="qual_formadora" placeholder="Qual a formadora?(Caso já tenha sido jovem aprendiz.)" required value="<?php echo e($interview->qual_formadora); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" id="fonte_curriculo" name="fonte_curriculo" placeholder="Fonte de Captação do Currículo" required value="<?php echo e($interview->fonte_curriculo); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" id="pontuacao" name="pontuacao" placeholder="Pontuação" required value="<?php echo e($interview->pontuacao); ?>">
