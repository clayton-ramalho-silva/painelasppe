...
<section class="cabecario">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo e(route('users.index')); ?>">Entrevista</a>ShowDev</li>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="RG" id="rg" name="rg" required value="<?php echo e($resume->informacoesPessoais->rg); ?>">
                            <?php $__errorArgs = ['rg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="CPF" id="cpf" name="cpf" required value="<?php echo e($resume->informacoesPessoais->cpf); ?>">
                            <?php $__errorArgs = ['cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Rua" id="logradouro" name="logradouro" required value="<?php echo e($resume->contato->logradouro); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-2">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Número" id="numero" name="numero" required value="<?php echo e($resume->contato->numero); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Complemento" id="complemento" name="complemento" value="<?php echo e($resume->contato->complemento); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Bairro" id="bairro" name="bairro" required value="<?php echo e($resume->contato->bairro); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Cidade" id="cidade" name="cidade" required value="<?php echo e($resume->contato->cidade); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-2">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="UF" id="uf" name="uf" required value="<?php echo e($resume->contato->uf); ?>">
                            <?php $__errorArgs = ['uf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="CEP" id="cep" name="cep" required value="<?php echo e($resume->contato->cep); ?>">
                            <?php $__errorArgs = ['cep'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="email" class="form-control floatlabel" placeholder="E-mail" id="email" name="email" required value="<?php echo e($resume->contato->email); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Telefone Celular" id="telefone_celular" name="telefone_celular" required value="<?php echo e($resume->contato->telefone_celular); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Telefone de Contato" id="telefone_residencial" name="telefone_residencial" value="<?php echo e($resume->contato->telefone_residencial); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Nome de Contato" id="nome_contato" name="nome_contato" value="<?php echo e($resume->contato->nome_contato); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/flav6095/painelasppe.com.br/resources/views/interviews/showDev.blade.php ENDPATH**/ ?>