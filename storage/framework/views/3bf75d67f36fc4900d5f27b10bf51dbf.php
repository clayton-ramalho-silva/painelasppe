...
<section class="cabecario">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Editar: <?php echo e($user->name); ?></li>
        </ol>
      </nav>
...
<section class="sessao">
    ...
    <article class="f1 container-form-create">
        ...
        <div class="container">
            ...
            <form action="<?php echo e(route('users.update', $user)); ?>" class="form-padrao" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6 form-campo">
                                <input type="text" class="form-control floatlabel" placeholder="Nome" id="name" name="name" value="<?php echo e($user->name); ?>" required>
                            </div>

                            <div class="mb-3 col-6 form-campo">
                                <input type="email" class="form-control floatlabel" placeholder="E-mail" id="email" name="email" value="<?php echo e($user->email); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="floatlabel-wrapper required">
                                    ...
                                    <select name="role" id="role" class="form-select active-floatlabel" required>
                                        <option></option>
                                        <option value="recruiter" <?php echo e($user->role == 'recruiter' ? 'selected' : ''); ?>>Recrutador</option>
                        ...
                        <div class="col-9 bloco-ativo d-flex mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" id="status" <?php echo e($user->status == '1' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="status"><?php echo e($user->status == '1' ? 'Ativo' : 'Inativo'); ?></label>
                            </div>
                        </div>
                    ...
                    <div class="col-3 border-start py-0 ps-5 form-r">
                        ...
                        <div class="mb-3 d-flex flex-column align-items-center">
                            ...
                            <div class="preview-container mb-3">
                                <?php if($user->image): ?>
                                    <img id="preview-image" src="<?php echo e(asset("documents/users/image/".$user->image)); ?>" class="preview-image" alt="Prévia da imagem">
                                <?php else: ?>
                                    <img id="preview-image" src="<?php echo e(asset('img/image-not-found.png')); ?>" class="preview-image" alt="Sem imagem">
                                <?php endif; ?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/flav6095/painelasppe.com.br/resources/views/auth/edit.blade.php ENDPATH**/ ?>