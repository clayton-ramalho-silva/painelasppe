...
class ResumesDExport implements FromCollection, WithHeadings, WithMapping, WithColumnFormatting, WithStyles
{
    /**
    ...
    public function collection()
    {
        ...
        })->with(['informacoesPessoais', 'escolaridade', 'contato'])->get();
