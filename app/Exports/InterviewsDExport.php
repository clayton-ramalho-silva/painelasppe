...
class InterviewsDExport implements FromCollection, WithHeadings, WithMapping, WithColumnFormatting, WithStyles
{
    /**
    ...
    public function collection()
    {
        ...
        $resumes = Resume::whereHas('informacoesPessoais', function ($query) use ($cpfsDuplicados) {
            $query->whereIn('cpf', $cpfsDuplicados);
        })->with(['informacoesPessoais', 'escolaridade', 'contato'])->get()->pluck('id')->toArray();



        return Interview::with(['resume', 'recruiter'])->whereIn('resume_id', $resumes)->get();
    }
