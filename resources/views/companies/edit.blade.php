                ...
                <div class="row">
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="nome_fantasia" name="nome_fantasia" value="{{ $company->nome_fantasia }}" required placeholder="Nome Fantasia">
                            ...
                            <div class="col-6 mb-3 form-campo position-relative">
                                ...
                                <input type="text" class="form-control floatlabel" id="cep" name="cep" value="{{ $company->location->cep }}" required placeholder="CEP">
                                @error('cep') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-12 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="logradouro" name="logradouro" value="{{ $company->location->logradouro }}" required placeholder="Endereço">
                                @error('logradouro') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-3 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="numero" name="numero" value="{{ $company->location->numero }}" required placeholder="Número">
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="bairro" name="bairro" value="{{ $company->location->bairro }}" required placeholder="Bairro">
                                @error('bairro') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="pais" name="pais" value="{{ $company->location->pais }}" required placeholder="País">
                                @error('pais') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-4 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="cidade" name="cidade" value="{{ $company->location->cidade }}" required placeholder="Cidade">
                            ...
                            {{-- <div class="col-2 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="uf" name="uf" value="{{ $company->location->uf }}" required placeholder="UF">
                                @error('uf') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div> --}}

                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="nome_contato" name="nome_contato" value="{{ $company->contacts->nome_contato }}" required placeholder="Nome do contato na empresa">
                                @error('nome_contato') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="email" class="form-control floatlabel" id="email" name="email" value="{{ $company->contacts->email }}" required placeholder="E-mail">
                                @error('email') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="tel" class="form-control floatlabel" id="telefone" name="telefone" value="{{ $company->contacts->telefone  }}" required placeholder="Telefone">
                                @error('telefone') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="tel" class="form-control floatlabel" id="whatsapp" name="whatsapp" value="{{ $company->contacts->whatsapp }}" required placeholder="(Whatsapp)">
