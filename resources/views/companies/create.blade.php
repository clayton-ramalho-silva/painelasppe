                ...
                <div class="row">
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="nome_fantasia" name="nome_fantasia" value="{{ old('nome_fantasia') }}" required placeholder="Nome Fantasia">
                            ...
                            <div class="col-6 mb-3 form-campo position-relative">
                                ...
                                <input type="text" class="form-control floatlabel" id="cep" name="cep" value="{{ old('cep') }}" required placeholder="CEP">
                                @error('cep') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-12 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="logradouro" name="logradouro" value="{{ old('logradouro') }}" required placeholder="Endereço">
                                @error('logradouro') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-3 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="numero" name="numero" value="{{ old('numero') }}" required placeholder="Número">
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="bairro" name="bairro" value="{{ old('bairro') }}" required placeholder="Bairro">
                                @error('bairro') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="pais" name="pais" value="{{ old('pais') }}" required placeholder="País">
                                @error('pais') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-4 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="cidade" name="cidade" value="{{ old('cidade') }}" required placeholder="Cidade">
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <input type="text" class="form-control floatlabel" id="nome_contato" name="nome_contato" value="{{ old('nome_contato') }}" required placeholder="Nome do contato na empresa">
                                @error('nome_contato') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="email" class="form-control floatlabel" id="email" name="email" value="{{ old('email', $company->email ?? '') }}" required placeholder="E-mail">
                                @error('email') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="tel" class="form-control floatlabel" id="telefone" name="telefone" value="{{ old('telefone', $company->telefone ?? '') }}" required placeholder="Telefone">
                                @error('telefone') <div class="alert alert-danger">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-6 mb-3 form-campo">
                                <input type="tel" class="form-control floatlabel" id="whatsapp" name="whatsapp" value="{{ old('whatsapp', $company->telefone ?? '') }}" required placeholder="(Whatsapp)">
