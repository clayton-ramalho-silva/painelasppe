        ...
        <div class="container mt-3">
            ...
            <form class="form-padrao" id="form-interview" action="{{ route('interviews.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" placeholder="Saúde do Candidato" id="saude_candidato" name="saude_candidato" required value="{{ old('saude_candidato') }}">
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" id="qual_formadora" name="qual_formadora" placeholder="Qual a formadora?(Caso já tenha sido jovem aprendiz.)" required value="{{ old('qual_formadora') }}">
                    ...
                    <div class="col-6 form-campo">
                        <div class="mb-3">
                            <input type="text" class="form-control floatlabel" id="fonte_curriculo" name="fonte_curriculo" placeholder="Fonte de Captação do Currículo" required value="{{ old('fonte_curriculo') }}">
